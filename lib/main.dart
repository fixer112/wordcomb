...
class HomeState extends State<Home> {
  ...
  adUnitId: 'ca-app-pub-3940256099942544/1033173712',
    ...
    _loadJson() async {
    String jsonCrossword = await DefaultAssetBundle.of(context).loadString('assets/json/words.json');
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        children: <Widget>[
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                          ...
                          if( (_clicks % 5== 0 || _clicks == 2 ) && enableClick){
                        ...
                        words = [];
                        permutation(word, "", int.parse(lengthController.text)).then((List list){
                           setState(() {
          ...
          Center(
            child: Text("Total Unscrambled Words : " + words.length.toString()),
          ),
          Expanded(
